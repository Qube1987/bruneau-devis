        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="p-6 sm:p-10">
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Devis Bruneau Protection</h1>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#29235C]/50 focus:border-transparent focus:bg-white transition-all min-h-[52px] text-gray-900 placeholder:text-gray-400"
